...
class AccountMove(models.Model):
	...
	pe_referral_guide = fields.Char(string='Guía de remisión')
	pe_purchase_request = fields.Char(string='Orden de compra')
	...
	# button_cancel es llamado desde button_anull que esta en el modulo base dv_l10n_pe_account_base
	...
	def action_invoice_sent(self):
		...
		self.ensure_one()
		if self.l10n_latam_document_type_id.is_cpe and self.pe_cpe_id:
			template = self.env.ref('dv_l10n_pe_sunat_electronic_invoice.email_template_edi_invoice_cpe2', False)
