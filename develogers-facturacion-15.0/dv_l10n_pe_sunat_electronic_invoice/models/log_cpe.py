...
class LogCPE(models.Model):
	...
	def action_enviar_log(self):
		...
		try:
			template_id = ir_model_data.get_object_reference('dv_l10n_pe_sunat_electronic_invoice', 'email_template_error_cpe')[1]
		except ValueError:
			template_id = False
		try:
