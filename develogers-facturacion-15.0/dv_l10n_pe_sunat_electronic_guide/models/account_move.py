...
class AccountMove(models.Model):
	...
	pe_stock_ids = fields.Many2many(comodel_name="stock.picking", string="Pickings", compute ="_compute_pe_stock_ids", readonly=True, copy=False)
	pe_stock_name = fields.Char("Número de picking", compute ="_compute_pe_stock_ids", copy=False)
